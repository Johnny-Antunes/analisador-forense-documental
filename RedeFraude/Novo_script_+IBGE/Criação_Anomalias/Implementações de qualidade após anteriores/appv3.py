...
if st.session_state["modo_descoberta_ativo"] and st.session_state["dados_descoberta"]:
    ...
    <div style="background: rgba(11, 17, 30, 0.95); border-left: 4px solid {cor_disc}; border-radius: 6px; padding: 8px 14px; margin-bottom: 12px; border-top: 1px solid #1E293B; border-right: 1px solid #1E293B; border-bottom: 1px solid #1E293B;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <span style="color: {cor_disc}; font-weight: 700; font-size: 13px;">⚡ FRAUD SCORE DO ALVO INÉDITO: {score_disc}/100 [{nivel_disc}]</span>
            <span style="color: #94A3B8; font-size: 11px;">Indicadores de Risco Comportamental (Descoberta Ativa)</span>
        </div>
...
# ====================================================================
    ...
    # -------------------------------------------------------------
    # SUB-ABA 2: BASE MESTRA DE ENTIDADES (SOFT DELETE FORENSE)
    # -------------------------------------------------------------
        ...
        if "Grafo" in nome_visao:
            ...
            if resumo_intel is None:
                ...
                if not df_novos_suspeitos.empty:
                    ...
                    with c_inc1:
                        if st.button("📥 Incorporar Novos Suspeitos à Base Mestra Desta Quadrilha", type="primary", use_container_width=True, key=f"btn_inc_{cluster_selecionado['id']}_{sufixo_key}"):
                            tot_inc = 0
