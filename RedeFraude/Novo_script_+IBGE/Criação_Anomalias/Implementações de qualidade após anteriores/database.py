...
# =====================================================
# GESTÃO DE NÓS OCULTADOS DO CASO ESPECÍFICO
# =====================================================
...
# =====================================================
# MANUTENÇÃO HISTÓRICA: REPARO DE MOJIBAKE & COORDENADAS
# =====================================================
...
def remover_entidade_suspeita(id_entidade, motivo=""):
    """
    Soft delete forense: não destrói o registro nem a cadeia de custódia.
    Marca o status como 'Removido' e grava data e justificativa.
    """
    conn = get_db_connection()
    try:
        cursor = conn.cursor()
...
def carregar_arquivos_para_sqlite(caminho_pasta_str, forcar_releitura=False):
    ...
    for idx_arq, arq in enumerate(arquivos_para_ler):
        ...
        try:
            ...
            # Captura B2B da Seguradora / Companhia Cliente
...
def cruzar_com_criacoes_diarias(cpfs_conhecidos, tels_conhecidos, placas_conhecidas):
    ...
    try:
        ...
        query = f"""
            SELECT data, id_assistencia, titular, cpf, telefone, placa, servico, bairro, cidade, uf, empresa_cliente
            FROM criacoes_diarias
            WHERE {' OR '.join(clausulas)}
        """
