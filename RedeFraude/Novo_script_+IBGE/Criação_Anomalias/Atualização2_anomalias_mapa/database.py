...
def reparar_mojibake_historico(progress_callback=None):
    """
    1. Repara nomes corrompidos por mojibake em todas as tabelas.
    2. Recalcula e atualiza latitude e longitude por municípios distintos em lote.
    """
    conn = get_db_connection()
    total_corrigidos = {
    ...
    try:
        ...
        for tabela in ["assistencias", "criacoes_diarias"]:
            ...
            # Recálculo geográfico por municípios distintos
