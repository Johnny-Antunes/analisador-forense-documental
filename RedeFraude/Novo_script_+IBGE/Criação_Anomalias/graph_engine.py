...
from database import (
    ...
    carregar_layout_caso, salvar_layout_caso
)
...
# =====================================================
# 2. SUBGRAFO FORENSE COM ROTA A & PERSISTÊNCIA DE LAYOUT
# =====================================================
def processar_subgrafo_caso(G, cluster_nodes, filtro_tipos, hub_id, font_slider=12, id_caso=""):
    ...
    # =========================================================================
    # ROTA A COM PERSISTÊNCIA EM BANCO & TRATAMENTO DEFENSIVO (PASSO 3)
    # =========================================================================
    ...
    if total_nos > 150:
        ...
        # Se o layout salvo cobre todos os nós atuais, reaproveita instantaneamente
...
# =====================================================
# 4. RENDERIZADOR HTML FORENSE VIS.JS (COM INSPECTOR DRAWER)
# =====================================================
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, sans-serif; }}
        ...
        /* =====================================================
           INSPECTOR DRAWER (PAINEL LATERAL FORENSE)
        ===================================================== */
        .drawer {{
            position: absolute;
            top: 0;
...
<body>
    ...
    <script>
        ...
        /* =====================================================
           CONTROLES DO INSPECTOR DRAWER FORENSE
        ===================================================== */
        function openInspector(nodeId) {{
            ...
            // Listagem de vizinhos conectados
            const neighborIds = network.getConnectedNodes(nodeId);
            document.getElementById('drawer-neighbors-count').innerText = neighborIds.length;
            ...
            neighborIds.forEach(nbId => {{
                ...
                item.innerHTML = `
                    ...
                    <span style="color:#94A3B8; font-size:10px;">${{nbObj.degree}} elos</span>
                `;
