...
# ====================================================================
# 7. TELA 1: PAINEL GERAL (CÉLULAS vs. BASE MESTRA vs. WATCHLIST CIDADES)
# ====================================================================
    ...
    aba_triagem = st.radio(
        "Navegação da Mesa:",
        ["🛡️ Células & Redes da Blacklist", "🎯 Base Mestra de Entidades Suspeitas", "📍 Watchlist de Municípios de Risco"],
        horizontal=True,
    ...
    # -------------------------------------------------------------
    # SUB-ABA 2: BASE MESTRA DE ENTIDADES (COM HISTÓRICO RESTAURADO)
    # -------------------------------------------------------------
        ...
        if suspeitos:
            ...
            for s in suspeitos:
                tabela_mestra.append({
                    ...
                    "Status": s["status"],
                    # HISTÓRICO TOTAL RESTAURADO COM CONTAGEM EM LOTE OTIMIZADA
    ...
    # -------------------------------------------------------------
    # SUB-ABA 3: 1a. WATCHLIST DE MUNICÍPIOS DE RISCO
    # -------------------------------------------------------------
    else:
